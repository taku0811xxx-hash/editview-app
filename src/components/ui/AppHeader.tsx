...
function EditviewLogo() {
  return (
    <svg width="100" height="28" viewBox="0 0 110 32" fill="none" aria-label="Editview">
      ...
      <text x="66" y="22" fontFamily="Georgia,serif" fontSize="18" fontWeight="400" fill="#888" letterSpacing="-0.5">view</text>
    </svg>
  )
}
...
export default function AppHeader() {
  ...
  return (
    <header className="bg-gray-950 border-b border-gray-800 h-12 flex items-center px-6 shrink-0">
